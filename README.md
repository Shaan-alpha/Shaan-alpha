...
| --- | --- | --- |
| [**Cog & Cosmos**](https://github.com/Shaan-alpha/Cog-and-Cosmos) · [▶ Play](https://shaan-alpha.github.io/Cog-and-Cosmos/) | Svelte 5 · TypeScript · PixiJS · Vite · PWA · break_eternity | A pixel-art interconnected incremental/idle game — eight interdependent worlds feed one brass Fortune Engine, with a four-tier prestige stack, achievements / collections / challenges, offline progress, and a free GitHub Pages + itch.io CI/CD pipeline. Also on [itch.io](https://shaan-alpha.itch.io/cog-and-cosmos) |
| [**AI Reel Factory**](https://github.com/Shaan-alpha/AI-Reel-Factory) | Python · GitHub Actions · Supabase · Gemini (search-grounded) · Groq · Google Chirp 3 HD TTS · Cloudflare Workers AI (Flux) · faster-whisper · FFmpeg · YouTube Data API | Fully autonomous, ~$0/month content factory publishing 4–5 daily YouTube Shorts to [@butitmatters](https://youtube.com/@butitmatters) — web-grounded ideation, Telegram one-tap approval, **near-human narration**, **AI-generated B-roll**, **cinematic auto-editing** (transitions · color grade · music ducking · brand bug), word-synced captions, idempotent fail-soft cloud pipeline |
...
- 🎬 Shipped **AI Reel Factory** — a fully autonomous, ~$0/month pipeline that researches news, writes scripts, narrates in a **near-human voice**, generates **AI B-roll**, **cinematically auto-edits** a captioned vertical video, and publishes daily YouTube Shorts to [**@butitmatters**](https://youtube.com/@butitmatters) — one Telegram tap is the only human input.
